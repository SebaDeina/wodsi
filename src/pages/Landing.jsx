    ...
    <div className="landing" style={shell}>
      ...
      <section className="landing-section landing-hero" style={{ position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{
          ...
          color: W.c.lime, marginBottom: 20, display: 'flex', alignItems: 'center', gap: 12,
        }}>
          <span style={{ width: 24, height: 1, background: W.c.lime }} />
          {t('hero_kicker', lang)}
        </div>
        <h1 style={{
          fontSize: 'clamp(40px, 11vw, 132px)', lineHeight: 0.95, letterSpacing: -3,
          fontWeight: 700, margin: '0 0 20px', maxWidth: 1100, fontFamily: W.font.display,
        }}>
        ...
        <p style={{ fontSize: 'clamp(16px, 4vw, 19px)', lineHeight: 1.5, color: W.c.dim, maxWidth: 620, margin: '0 0 28px' }}>
          {t('hero_sub', lang)}
        </p>
        <div style={{ display: 'flex', gap: 12, alignItems: 'center', flexWrap: 'wrap' }}>
          <Btn primary onClick={goSignupCoach}>{t('hero_cta1', lang)} →</Btn>
          <Btn ghost>▷ &nbsp;{t('hero_cta2', lang)}</Btn>
          <span className="landing-hero-cta-note" style={{ fontSize: 11, color: W.c.mute, fontFamily: W.font.mono }}>
      ...
      <section className="landing-section landing-metrics" style={{ borderTop: `1px solid ${W.c.lineDim}`, borderBottom: `1px solid ${W.c.lineDim}` }}>
        {[['1.240','metric1'],['38.500','metric2'],['82k','metric3'],['4.9★','metric4']].map(([n, k]) => (
          <div key={k}>
            <div className="landing-metrics-num" style={{ fontWeight: 700, letterSpacing: -2, fontFamily: W.font.display, lineHeight: 1 }}>{n}</div>
      ...
      <section className="landing-section" style={{ paddingTop: 64, paddingBottom: 64 }}>
        <div className="landing-features-head" style={{ display: 'flex', marginBottom: 40 }}>
          <div>
      ...
      <section className="landing-section" style={{ paddingTop: 64, paddingBottom: 64 }}>
        ...
        <div className="landing-pricing-grid">
          {[
            ...
            <PricingCard key={p.name} p={p} lang={lang} onCta={goSignupCoach} />
          ))}
        </div>
      </section>
...
function cardShell(children, extra = {}) {
  return (
    <div style={{
      background: W.c.bg2, borderRadius: 16, padding: 24, minHeight: 280,
    ...
    <>
      ...
      <div style={{ marginTop: 16, display: 'flex', gap: 8, flexWrap: 'wrap' }}>
        {['EMOM','AMRAP','For Time','Tabata'].map(name => (
          <div key={name} style={{
            padding: '10px 14px', background: W.c.card, borderRadius: 10,
            fontFamily: W.font.mono, fontSize: 12, fontWeight: 600,
...
function PricingCard({ p, lang, onCta }) {
  return (
    <div style={{
