/** Misma ventana que src/lib/planningNotifyWindow.js (worker sin bundler compartido). */
...
export function isWithinPlanningNotifyWindow(now = new Date()) {
  return computePlanningSendAfter(now) === null
}
